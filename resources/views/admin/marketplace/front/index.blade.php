...
@section('content')
  ...
  <div class="col-lg-2">
    <div class="title-action">
      <a href='frontend_/create' class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;Tambah Data</a>
    </div>
  </div>
@stop
    ...
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        <div class="ibox-title">
          <h5>List Frontend for Marketplace</h5>
          <div class="ibox-tools"><!-- any link icon --></div>
        </div>
        <div class="ibox-content">
          <table class="table table-striped table-bordered table-hover dataTables-example" id="frontend-table">
            <thead>
              <tr>
                <th>Type</th>
                <th>Name</th>
...
<script>
$(function() {
  var url = "{{ url('admin/marketplace/frontend/') }}";
  $('#frontend-table').DataTable({
    processing: true,
    serverSide: true,
    order: [[ 3, "asc" ]],
    ajax: "{{ url('admin/ajax/marketplace/frontend')}}",
    columns: [            
      { "data" : "type" },
      { "data" : "name" },
      { "data" : "position" },
...
$('#submit_delete').on('click', function (event) {  
  $.ajax({
    ...
    var ref = $('#frontend-table').DataTable();
