        ...
        <div class="ibox-content">
          <div class="row">
            <div class="col-lg-12">
              ...
              <div class="form-group no-padding">
                <label class="col-lg-2 control-label no-padding">Email</label>
                <div class="col-lg-10">
                  <p class="form-control-static no-padding">{{ $member->email }}</p>
                </div>
              </div>
              <div class="form-group no-padding">
                <label class="col-lg-2 control-label no-padding">Submitted At</label>
              ...
              <div class="form-group no-padding">
                ...
                <div class="col-lg-10">
                  @if ($member->role=3)
                    <p class="form-control-static no-padding">Indonesia</p>
                  @else                  
                    <p class="form-control-static no-padding">{{ $member->territory_name }}</p>
                  @endif
                </div>
