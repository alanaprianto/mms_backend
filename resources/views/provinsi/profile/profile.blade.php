                        ...
                        <td class="content-wrap">
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="content-block">
                                            Permintaan KTA anda telah berhasil digenerate. Berikut adalah nomor KTA Anda<br>
                                            {{ $kta }}<br>
                                            Mohon diperhatikan, Nomor KTA bersifat abadi atau nomor yang anda miliki tidak akan digenerate lagi. Bila nomro KTA anda tidak tervalidasi, kemungkinan nomor KTA anda telah habis masa berlaku. Gunakan fitur perpanjangan KTA untuk memperpanjang masa berlaku KTA anda.                                            
                                        </td>
                                    </tr>                                    
                                    <tr>
                                        <td class="content-block">
