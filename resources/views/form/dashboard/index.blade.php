...
$(function() {
  setInterval(function(){
    $.post("{{ url('crud/form/chart/adm_member') }}", {_token: "{{ csrf_token() }}"}, function(result){
      $("#txt-newmember").html(result.newmember);
      $("#txt-ttlmember").html(result.ttlmember);
    });
    
    $.post("{{ url('crud/form/chart/adm_dynform') }}", {_token: "{{ csrf_token() }}"}, function(result){
    ...
    $.post("{{ url('crud/form/chart/adm_donut') }}", {_token: "{{ csrf_token() }}"}, function(result){
      if (result.success) {      
        $(function() {        
          dt = result.datas;          
    ...
    $.post("{{ url('crud/form/chart/adm_dblbar') }}", {_token: "{{ csrf_token() }}"}, function(result){
      if (result.success) {
