      ...
      <div class="container">
        <div class="navbar-header page-scroll">
          <a href="https://devtes.com/portal/kadin-indonesia" class="f_left logo">
              <img src="{{ asset('frontend/images/logo_kadin.png') }}" class="" style="max-width: 400px;" alt="">
          </a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
              ...
              <li class="top-drop @yield('memberactive')">
                ...
                <ul class="ul-drop">
                  <li><a href="{{ url('register/ab')}}">Anggota Biasa</a></li>
                  <li><a href="{{ url('register/alb')}}">Anggota Luar Biasa</a></li>
                </ul>
              </li>
...
<script src="{{ asset('js/register/inspinia.js') }}"></script>
