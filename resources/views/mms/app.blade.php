...
<head>    
    ...
    <link href="{{ asset('resources/assets/mainassets/socicon/css/socicon.min.css') }}" rel="stylesheet">
    <link href="{{ asset('resources/assets/mainassets/animate.css/animate.min.css') }}" rel="stylesheet">
...
<section class="mbr-section mbr-section__container mbr-after-navbar" id="header3-0" style="background-color: rgb(184, 49, 47); padding-top: 40px; padding-bottom: 40px;">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
        ...
        <div class="row">
            <div class="mbr-footer-content col-xs-12 col-md-3">
                <p><strong>Address</strong><br>
                    ...
                    Jl. H.R. Rasuna Said X-5 Kav. 2-3 Jakarta 12950 Indonesia <br><br><br>
                    <strong>Contacts</strong><br>
                    Email: sekretariat@kadin-indonesia.or.id<br>
...
<script src="{{ asset('resources/assets/mainassets/viewportChecker/jquery.viewportchecker.js') }}"></script>
