            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>List Organizer</h5>
                        <div class="ibox-tools"><!-- any link icon --></div>
                    </div>
                    <div class="ibox-content">
                        <table class="table table-striped table-bordered table-hover dataTables-example" id="list-table">
                            <thead>
                            <tr>
                                <th>Name</th>
                                <th>Email</th>
...
<script>
    $(function() {
        var url = "{{ url('admin/organizer/list/') }}";
            ...
            "columnDefs": [
                {
                    "render": function ( data, type, row ) {
                        return "<div class='pull-right'>"+
                            "<a href='list/"+row.id+"/edit' class='btn btn-xs btn-warning'><i class='fa fa-edit'></i> Edit </a>&nbsp;"+
                            "<a class='btn btn-xs btn-danger' data-toggle='modal' data-target='#myModal' data-id='"+row.id+"' data-name='"+row.name+"' data-url='list' title='Delete Item'><i class='fa fa-trash'></i> Delete </a>&nbsp;"+
                            "</div>";
                    },
                    "targets": 4
                },
